...
// Seleciona os elementos que possuem o atributo data-key
function updateContent(language) {
    ...
    elements.forEach(element => {
        ...
        if (translation) {
            // Log para depuração
            console.log(`Atualizando a chave ${key}: ${translation}`);

            // Caso a tradução seja uma string simples, substitui o conteúdo
            if (typeof translation === 'string') {
                element.innerHTML = translation;
            }
            // Caso a tradução seja um array (ex: introContent), junta com <br>
